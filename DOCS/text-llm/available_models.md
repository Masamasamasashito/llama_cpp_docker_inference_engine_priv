...
| 用途 | 種別 | おすすめモデル | 備考 |
|---|---|---|---|
| 日本語汎用 | テキスト | Qwen3.5-27B / Gemma 3 27B | |
| 日本語特化 | テキスト | RakutenAI 2.0 8x7B / RakutenAI 7B | |
| 高速レスポンス | テキスト | Qwen3.5-9B / RakutenAI 7B | |
| コーディング | テキスト | Qwen3-Coder-30B | |
| 推論・分析 | テキスト | DeepSeek R1 32B | |
| 最高品質 | テキスト | Qwen3-32B | |
| 動画生成（高速） | 動画 | LTX-Video | 5秒動画を約4秒で生成。VRAM ~8GB |
| 動画生成（高品質） | 動画 | Wan 2.1/2.2 (14B) | 最高品質。VRAM ~12-16GB |
| 動画生成（人物） | 動画 | HunyuanVideo 1.5 | 人物の顔が得意。VRAM ~16GB |

> 動画生成モデルの詳細は [動画生成モデル一覧](../video-generation/available_models.md) を参照してください。
