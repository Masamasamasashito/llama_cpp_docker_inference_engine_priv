...
|---|---|---|---|---|---|---|---|---|
| `docker-compose.yml` | 8081 | 99層 | 32768 | 4 | 8 | — | — | 標準GPU推論 |
| `docker-compose.cpu.yml` | 8082 | — | 2048 | 1 | — | — | 8GB上限/4GB予約 | GPU不要の検証用 |
| `docker-compose.high.yml` | 8083 | 99層 | 65536 | 16 | 24 | 4096/2048 | — | RTX 5090最適化 |

> **GPU版 vs High版の違い:** High版はRTX 5090 (32GB VRAM) 向けにコンテキスト2倍(65536)、並列4倍(16)、バッチ処理(4096/2048)、スレッド3倍(24)に強化。
